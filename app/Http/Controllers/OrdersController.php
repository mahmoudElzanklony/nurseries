...
class OrdersController extends Controller
{
    ...
    public function make_order(ordersFormRequest $request){
        ...
        if($check_err_delivery['error'] > 0){
            return messages::error_output($seller->username.' '.trans('keywords.dont_support_delivery_product').' '.$check_err_delivery['product_name'].trans('keywords.to_default_address'),401);
        }
