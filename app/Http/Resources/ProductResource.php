    ...
    public function toArray($request)
    {
        ...
        if(isset($this->discounts)){
            try{
                ...
                dd(Carbon::today() >= Carbon::make($this->discounts[0]->start_date) && Carbon::today() <= Carbon::make($this->discounts[0]->end_date)  );
                if(Carbon::today() >= Carbon::make($this->discounts[0]->start_date) && Carbon::today() <= Carbon::make($this->discounts[0]->end_date) ){
