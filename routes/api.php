...
Route::group(['middleware'=>'changeLang'],function (){
    ...
    Route::group(['prefix'=>'/auth'],function(){
        ...
        Route::post('/test-sms',[AuthControllerApi::class,'test_sms']);
        Route::post('/get-user-by-token',[AuthControllerApi::class,'get_user_by_token'])->middleware('CheckApiAuth');
    ...
    Route::get('/categories-data/questions',[CategoriesControllerResource::class,'cat_questions']);
    ...
    Route::group(['prefix'=>'/dashboard','middleware'=>['CheckApiAuth']],function(){
        ...
        Route::group(['prefix'=>'/orders'],function(){
            ...
            Route::get('/canceled-orders',[DashboardController::class,'canceled_orders']);
        });
